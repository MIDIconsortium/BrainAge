...
IXI_directory is the absolute path to the directory where the IXI scans have been unzipped to, and contains files such as 'IXI497-Guys-1002-T2.nii' etc. Path_to_IXI_csv is the location of the saved IXI csv file e.g., /home/user/Downloads/IXI.xls' etc.

This command will create a local directory (IXI_nii) containing pre-processed scans.
